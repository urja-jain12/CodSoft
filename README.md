...
- Trained a **Linear Support Vector Machine (SVM)** classifier to learn patterns associated with different movie genres.
...
- Used transaction attributes as input features.
- Trained a **Random Forest Classifier** to distinguish between legitimate and fraudulent transactions.
...
- Analyzed customer demographic and banking information.
- Encoded categorical features and scaled numerical features.
- Built the prediction model using a **Random Forest Classifier**.
